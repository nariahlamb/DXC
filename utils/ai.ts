...
【玩家姓名】${playerName}
  1. **第三人称叙述原则**:
     ...
     - **玩家指代规则**: 统一使用“${playerName}”指代玩家，禁止使用“你/我/他/她/他们/她们/<玩家>”等人称代词或占位符。
...
【玩家姓名】${playerName}
  1. **第二人称叙述原则**:
     - **视角限制**: 所有叙述必须采用第二人称直呼视角，描写玩家角色所见、所闻、所感，但玩家指代必须使用“${playerName}”。禁止使用“你/我/他/她/他们/她们/<玩家>”等人称代词或占位符。
     - **玩家指代规则**: 使用玩家姓名作为直接呼称，保持第二人称的对话感。
...
【玩家姓名】${playerName}
  1. **第一人称叙述原则**:
     - **视角限制**: 所有叙述必须采用第一人称主观视角，但自称必须使用“${playerName}”。禁止使用“我/你/他/她/他们/她们/<玩家>”等人称代词或占位符来指代玩家。
     - **玩家指代规则**: 使用玩家姓名作为自称，保持第一人称的主观感受与语气。
