...
describe('memory service log table fill', () => {
  ...
  it('keeps SYS_GlobalState/NPC story table commands when corresponding services are not configured', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('rewrites malformed upsert_sheet_rows legacy key payload into SYS_GlobalState update', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('keeps valid legacy updates when a rumor field legacy command cannot be bridged', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('bridges malformed upsert_sheet_rows legacy key payload for inventory and quest status', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('bridges malformed upsert_sheet_rows quest log payload into QUEST_ProgressLog', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('does not rollback whole batch when legacy economy/phone keys are present and bridges them', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('blocks malformed legacy path-like upsert payload in triad-only runtime', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('accepts multi-sheet array payload in one upsert_sheet_rows command without breaking primary updates', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('ignores malformed upsert_sheet_rows undefined payload without rolling back valid updates', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('sanitizes invalid AM index in append_log_summary instead of dropping the command', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('accepts cmd+args shaped commands without missing action/key errors', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
  ...
  it('accepts name+args shaped commands without missing action/key errors', async () => {
    (generateDungeonMasterResponse as any).mockResolvedValueOnce({
