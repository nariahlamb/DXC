...
const QUALITY_MAP: Record<string, 'Broken' | 'Common' | 'Rare' | 'Epic' | 'Legendary' | 'Pristine'> = {
  Broken: 'Broken',
  Common: 'Common',
  Rare: 'Rare',
  Epic: 'Epic',
...
export const normalizeQuality = (quality?: string): 'Broken' | 'Common' | 'Rare' | 'Epic' | 'Legendary' | 'Pristine' => {
