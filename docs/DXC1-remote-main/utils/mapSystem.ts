...
import { Direction, Enemy, WorldMapData, OrarioLocation, DungeonLayer, MapFaction, TerritoryData, TradeRoute, TerrainFeature, MapMacroLocation, MapMidLocation } from "../types";
...
export const resolveLocationHierarchy = (mapData: WorldMapData | undefined, locationName?: string): { macro?: string; mid?: string } => {
    ...
    // Enhanced normalization to match logic in useGameLogic.ts
