...
export default function App() {
  ...
  return (
    <main className="w-full h-dvh bg-dungeon-black text-hestia-blue-100 font-body antialiased overflow-hidden selection:bg-red-600 selection:text-hestia-blue-100 flex justify-center">
      <div className="w-full max-w-[1920px] h-full relative shadow-2xl flex flex-col">
